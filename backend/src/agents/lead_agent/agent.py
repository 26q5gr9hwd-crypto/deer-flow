...
from src.agents.middlewares.vesper_context_middleware import VesperContextMiddleware
from src.agents.middlewares.subagent_limit_middleware import SubagentLimitMiddleware
from src.agents.middlewares.thread_data_middleware import ThreadDataMiddleware
# # # # # from src.agents.middlewares.title_middleware import TitleMiddleware  # VESPER-2: removed  # VESPER-2: removed  # VESPER-2: removed  # VESPER-2: removed  # VESPER-2: removed
...
def _build_middlewares(
    ...
    # VESPER-2: TitleMiddleware removed (saves 1 LLM call per message)
    # middlewares.append(TitleMiddleware())

    # VESPER-2: Add VesperContextMiddleware for structured context assembly
    middlewares.append(VesperContextMiddleware())

    # Add MemoryMiddleware (after context assembly)
